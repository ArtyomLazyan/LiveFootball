                        ...
                        <form role="form" action="" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="<?=$livestream["title"]; ?>">
                                </div>

                                <div class="form-group">
                                    <label>Visibility</label>
                                    <select class="form-control" name="visibility">
                                        <?php if ($livestream["visibility"] == "public") : ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="html" rows="3" ><?=$livestream["html"]; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Livestream Description</label>
                                    <textarea class="form-control" name="description" rows="3"><?=$livestream["description"]; ?></textarea>
                                </div>

                            </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                                <button type="submit" name="update_livestream" class="btn btn-primary">Update Article</button>
                            </div>
                        </form>
                    </div>
                </div>
